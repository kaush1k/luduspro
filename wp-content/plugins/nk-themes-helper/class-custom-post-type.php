...
/**
 * Class NK_Helper_Custom_Post_Type
 */
class NK_Helper_Custom_Post_Type {
    /**
     * Post type name.
    ...
    public function add_admin_columns( $columns ) {
        ...
        if ( ! isset( $this->columns ) ) {
            ...
            if ( is_array( $this->taxonomies ) && in_array( 'post_tag', $this->taxonomies ) || 'post' === $this->post_type_name ) {
                $after = 'tags';
            } elseif ( is_array( $this->taxonomies ) && in_array( 'category', $this->taxonomies ) || 'post' === $this->post_type_name ) {
                $after = 'categories';
