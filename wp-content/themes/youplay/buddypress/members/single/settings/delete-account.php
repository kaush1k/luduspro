...
<div id="message" class="info">
	...
	<?php if ( bp_is_my_profile() ) : ?>
		...
		<p><?php _e( 'Deleting your account will delete all of the content you have created. It will be completely irrecoverable.', 'youplay' ); ?></p>

	<?php else : ?>

		<p><?php _e( 'Deleting this account will delete all of the content it has created. It will be completely irrecoverable.', 'youplay' ); ?></p>
...
<form action="<?php echo bp_displayed_user_domain() . bp_get_settings_slug() . '/delete-account'; ?>" name="account-delete-form" id="account-delete-form" class="standard-form" method="post">
	...
	<div class="youplay-checkbox ml-10">
		...
		<label for="delete-account-understand"><?php _e( 'I understand the consequences.', 'youplay' ); ?></label>
	</div>

	<div class="submit">
        <span class="btn btn-default">
            <?php esc_html_e( 'Delete Account', 'youplay' ); ?>
            <input type="submit" value="<?php esc_attr_e( 'Delete Account', 'youplay' ); ?>" id="delete-account-button" name="delete-account-button" />
        </span>
	</div>
