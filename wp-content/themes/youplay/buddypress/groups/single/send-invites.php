	...
	<form action="<?php bp_group_send_invite_form_action(); ?>" method="post" id="send-invite-form" class="standard-form">
		...
		<div class="submit">
            <span class="btn btn-default">
                <?php esc_html_e( 'Send Invites', 'youplay' ); ?>
                <input type="submit" value="<?php esc_attr_e( 'Send Invites', 'youplay' ); ?>" id="submit" name="submit" />
            </span>
		</div>
...
elseif ( 0 == bp_get_total_friend_count( bp_loggedin_user_id() ) ) : ?>
	...
	<div id="message" class="info">
		<p class="notice"><?php _e( 'Group invitations can only be extended to friends.', 'youplay' ); ?></p>
		<p class="message-body"><?php _e( "Once you've made some friendships, you'll be able to invite those members to this group.", 'youplay' ); ?></p>
	</div>
...
/* The user does have friends, but none are eligible to be invited to this group. */
	...
	<div id="message" class="info">
		<p class="notice"><?php _e( 'All of your friends already belong to this group.', 'youplay' ); ?></p>
	</div>
