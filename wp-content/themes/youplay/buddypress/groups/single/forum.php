	...
	<div class="item-list-tabs no-ajax" id="subnav" role="navigation">
		<ul>
			...
			<?php if ( is_user_logged_in() ) : ?>
				...
				<li>
					<a href="#post-new" class="show-hide-new"><?php _e( 'New Topic', 'youplay' ); ?></a>
				</li>
			...
			<?php if ( bp_forums_has_directory() ) : ?>
				...
				<li>
					<a href="<?php bp_forums_directory_permalink(); ?>"><?php _e( 'Forum Directory', 'youplay' ); ?></a>
				</li>
...
<?php if ( !bp_is_group_forum_topic_edit() && !bp_is_group_forum_topic() ) : ?>
	...
	<?php if ( !bp_group_is_user_banned() && ( ( is_user_logged_in() && 'public' == bp_get_group_status() ) || bp_group_is_member() ) ) : ?>
		...
		<form action="" method="post" id="forum-topic-form">
			<div id="new-topic-post">
				...
				<?php if ( bp_groups_auto_join() && !bp_group_is_member() ) : ?>
					<p><?php _e( 'You will auto join this group when you start a new topic.', 'youplay' ); ?></p>
				<?php endif; ?>

				<p id="post-new"></p>
				<h4><?php _e( 'Post a New Topic:', 'youplay' ); ?></h4>

				<label for="topic_title"><?php _e( 'Title:', 'youplay' ); ?></label>
				<div class="youplay-input">
					<input type="text" name="topic_title" id="topic_title" value="" maxlength="100" />
				</div>

				<label for="topic_text"><?php _e( 'Content:', 'youplay' ); ?></label>
				<div class="youplay-textarea">
					<textarea name="topic_text" id="topic_text" rows="5"></textarea>
				</div>

				<label for="topic_tags"><?php _e( 'Tags (comma separated):', 'youplay' ); ?></label>
				<div class="youplay-input">
				...
				<div class="submit">
                    <span class="btn btn-default">
                        <?php esc_html_e( 'Post Topic', 'youplay' ); ?>
                        <input type="submit" value="<?php esc_attr_e( 'Post Topic', 'youplay' ); ?>" id="submit" name="submit_topic" />
                    </span>
				</div>
